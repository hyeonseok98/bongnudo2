...
export function HomeHero() {
  return (
    <header
      className={`${heroStyles.hero} relative flex h-72 items-center justify-center overflow-hidden bg-surface-raised text-center sm:h-80 lg:h-88`}
    >
      <Image
        fill
        priority
      ...
      <div className="relative flex max-w-3xl flex-col items-center px-4">
        <Image
          alt="BONGNUDO2"
          className="h-auto w-64 mix-blend-screen sm:w-80 lg:w-96"
          height={724}
          priority
