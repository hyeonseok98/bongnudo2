export const RP_AFFILIATION_BADGE_STYLES: Record<string, string> = {
  ...
  gang: "bg-job-gang/10 text-job-gang-foreground",
  crew: "bg-job-crew/10 text-job-crew-foreground",
  citizen: "bg-job-citizen/10 text-job-citizen-foreground",
};

export const RP_AFFILIATION_BADGE_FALLBACK = "bg-white/10 text-white/90";
